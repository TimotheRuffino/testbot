...
require 'twitter'
require 'pry'
#require 'pry' #=> ca bugue si on utilise pas avec "blinding.pry"
...
#def tweet_a_journalist(journalists)
  #journalists_sample = journalists.sample(5)
  #for i in journalists_sample 
    #login_twitter.update ("#{i}! Salut l'ami, merci pour ton travail d'information ! #bonjour_monde @the_hacking_pro")
  #end
#end
...
#def tweet_bonjour_monde(client)
 # last_tweets_bonjour_monde = client.search("#bonjour_monde", result_type: "recent").take(25)
  #return last_tweets_bonjour_monde
#end

#def favorites(last_tweets_bonjour_monde, client)
 # last_tweets_bonjour_monde.each do |like|
  #   client.favorite(like.id)
  #end
#end

#def perform
 # client = login_twitter
  #last_tweets_bonjour_monde = tweet_bonjour_monde(client)
  #favorites(last_tweets_bonjour_monde, client)
  #end
